...
class _DismissiblemyClipper extends CustomClipper<Rect> {
  _DismissiblemyClipper({
    @required this.axis,
  ...
  @override
  bool shouldReclip(_DismissiblemyClipper oldClipper) {
