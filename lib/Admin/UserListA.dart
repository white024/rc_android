// ignore_for_file: avoid_print, camel_case_types, unused_element, must_call_super, prefer_typing_uninitialized_variables, deprecated_member_use, prefer_interpolation_to_compose_strings, unnecessary_const, sort_child_properties_last
      ...
      child: Scaffold(
          ...
          body: RefreshIndicator(
              child: ListView.builder(
                itemCount:
                    userprovider.users == null ? 0 : userprovider.users.length,
                  ...
                  return Dismissible(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text("ID: " +
                              userprovider.users[index].idKullanici.toString()),
